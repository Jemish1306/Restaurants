...
export default function LoginScreenErrorPage() {
  return (
    <>
      <Helmet>
              ...
              <div className="flex flex-col items-center self-stretch">
                <div className="flex flex-col items-start gap-1 self-stretch">
                  ...
                  <Input
                    ...
                    className="mb-6 border-blue_gray-200_3f !text-blue_gray-200 sm:pr-5"
                  />
                </div>
                <div className="flex flex-col items-start gap-[5px] self-stretch">
                  <div className="flex flex-col items-start gap-1 self-stretch">
                    ...
                    <Input
                      ...
                      className="gap-[35px] border-red-500_01"
                    />
                  </div>
                  <Text as="p" className="!font-normal !text-red-500_01">
                    Incorrect Password.
                  </Text>
                </div>
